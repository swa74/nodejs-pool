...
function Coin(data){
    ...
    this.coinDevAddress = "Se2qr4ovTU2SiAbE1KyMLR4kQYKFWhB3V8mxijFfwdYTJVnw4ZdsAHw294cHoypTYyc1sbUv2hTqr7q8GVBmSB9Q1a2L26BTn";  // ArqTras Address
    this.poolDevAddress = "Se2qr4ovTU2SiAbE1KyMLR4kQYKFWhB3V8mxijFfwdYTJVnw4ZdsAHw294cHoypTYyc1sbUv2hTqr7q8GVBmSB9Q1a2L26BTn";  // ArqTras Address
    ...
    this.prefix = 9241;
    this.intPrefix = 28822; //cnUtil.address_decode_integrated(new Buffer(config.poolServer.poolAddress));
