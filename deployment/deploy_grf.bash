...
cd ~
git clone https://github.com/swa74/nodejs-pool.git  # Change this depending on how the deployment goes.
cd /usr/src/gtest
sudo cmake .
sudo make
...
mysql -u root --password=$ROOT_SQL_PASS < deployment/basegrf.sql
