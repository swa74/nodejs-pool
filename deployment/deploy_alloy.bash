...
cd ~
git clone https://github.com/ArqTras/nodejs-pool.git nodejs-pool  # Change this depending on how the deployment goes.
cd /usr/src/gtest
sudo cmake .
sudo make
...
sudo mysql -u root --password=$ROOT_SQL_PASS < deployment/basexao.sql
