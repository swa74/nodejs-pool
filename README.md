...
Install Script: curl -L https://raw.githubusercontent.com/swa74/nodejs-pool/master/deployment/deploy_grf.bash | bash
...
Install Script:
```bash
curl -L https://raw.githubusercontent.com/swa74/nodejs-pool/master/deployment/deploy_grf.bash | bash
```
